...
'stocktend_inventory'.click()
  ...
  'stocktend_settings'.click()
    'Utilities'.click()
      ...
      'helper'.addToExportedJsonData({product: 'Hoodie with Logo (HL01)', quantityOnHand: 20})
      'helper'.addToExportedJsonData({product: 'Hoodie with Pocket (HP01)', quantityOnHand: "30"})
      'Import'.click()
  ...
  'stocktend_settings'.click()
    'Utilities'.click()
      ...
      'Import'.click()
        ...
        'helper'.addToExportedJsonData({$RowType: 'Header', purchaseOrderNumber: 'PO00004', supplier: 'John', orderDate: '14/08/2020', expectedDeliveryDate: '14/08/2020'})
        'helper'.addToExportedJsonData({$RowType: 'LineItem', 'LineItem.purchaseOrder': 'PO00004', 'LineItem.product': 'Hoodie (H01)', 'LineItem.quantity': 1, 'LineItem.unitCostIncTaxFX': '200.00', 'LineItem.taxPct': 20})
        'helper'.addToExportedJsonData({$RowType: 'LineItem', 'LineItem.purchaseOrder': 'PO00004', 'LineItem.lineType': 'Fee', 'LineItem.unitCostIncTaxFX': '10.00', 'LineItem.taxPct': 10})
        'helper'.addToExportedJsonData({$RowType: 'Header', purchaseOrderNumber: 'PO00005', orderDate: '14/08/2020', expectedDeliveryDate: '14/08/2020'})
        'helper'.addToExportedJsonData({$RowType: 'LineItem', 'LineItem.purchaseOrder': 'PO00005', 'LineItem.product': 'Hoodie (H01)', 'LineItem.quantity': 7, 'LineItem.unitCostIncTaxFX': '20.00'})
        'Excel File to Import From'.useExportedJsonData()
        'Start Importing'.click()
...
'mainTable./Shórts - Blue (SB01)/.View History'.click()
  ...
  'mainTable.0.Date'.shouldEqualExpression('global.todayLocal().toLocalMMMDY()')
...
'Inventory History'.shouldBeCurrentPage()
'mainTable.0.Date'.shouldEqualExpression('global.todayLocal().incDays(-1).toLocalMMMDY()')
'mainTable.0.Quantity'.shouldEqual('-1')
'mainTable.0.Balance'.shouldEqual('1')
