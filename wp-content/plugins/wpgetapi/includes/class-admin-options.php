	...
	public function admin_page_display() {
		...
		<div class="wrap wpgetapi">
			...
			<div class="sidebar_cell">
				<div class="box">
					<h3>Help & Tips</h3>
					<p><a class="button-primary" target="_blank" href="https://wpgetapi.com/docs/?utm_campaign=Help&utm_medium=Admin&utm_source=User">View The Docs</a></p>
					<ul>
					<li><b>Using the Template Tag within your theme is the most flexible option and is recommended.</b></li>
					<li>The Template Tag will 'return' data only. To output to your page you will need to 'echo' or 'var_dump'.</li>
					<li>Trying to 'echo' the data when using the 'JSON (as array data)' option will result in a PHP warning. You will need to use 'var_dump' instead to see the output.</li>
					<li>Using the Shortcode within a page (or post) becomes a little more flexible when used in conjunction with our <a target="_blank" href="https://wpgetapi.com/downloads/pro-plugin/?utm_campaign=Pro&utm_medium=Admin&utm_source=User">Pro plugin</a>.</li>

					<li>You can get nested data from the array using our <a target="_blank" href="https://wpgetapi.com/downloads/pro-plugin/?utm_campaign=Pro&utm_medium=Admin&utm_source=User">Pro Plugin</a> extension using either Shortcode or Template Tag.</li>
					</ul>
				</div>
